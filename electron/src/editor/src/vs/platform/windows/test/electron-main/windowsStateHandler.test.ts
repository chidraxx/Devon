	...
	test('open 1_32', () => {
		const v1_32_workspace = `{
			...
			"lastActiveWindow": {
				...
				"backupPath": "/home/user/.config/devon-dev/Backups/53b714b46ef1a2d4346568b4f591028c",
				"uiState": {
					"mode": 0,
					"x": 0,
					"y": 27,
		...
		const v1_32_folder = `{
			...
			"lastActiveWindow": {
				...
				"backupPath": "/home/user/.config/devon-dev/Backups/1daac1621c6c06f9e916ac8062e5a1b5",
				"uiState": {
					"mode": 1,
					"x": 625,
					"y": 263,
		...
		const v1_32_empty_window = ` {
			...
			"lastActiveWindow": {
				"backupPath": "/home/user/.config/devon-dev/Backups/1549539668998",
				"uiState": {
					"mode": 1,
					"x": 768,
					"y": 336,
